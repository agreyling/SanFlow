...
begin
  if frmZoneVariables.Date.Text = '' then
    Calendar.UseCurrentDate := true
  else
  begin
    Calendar.UseCurrentDate := false;
    Calendar.Day   := StrToInt(Copy(frmZoneVariables.Date.Text,1,2));
    Calendar.Month := StrToInt(Copy(frmZoneVariables.Date.Text,4,2));
    Calendar.Year  := StrToInt(Copy(frmZoneVariables.Date.Text,7,4));
  end;
...
begin
  frmZoneVariables.Date.Text := AddZero(Calendar.Day)+DateSeparator+
                               AddZero(Calendar.Month)+DateSeparator+
