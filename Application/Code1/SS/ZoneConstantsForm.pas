...
var
 ZoneConstantsFm : TZoneConstantsFm;

implementation

{$R *.DFM}

procedure TZoneConstantsFm.CancelBtnClick(Sender: TObject);
begin
  ZoneConstantsFm.Hide;
end;

procedure TZoneConstantsFm.SaveBtnClick(Sender: TObject);
begin
...
procedure TZoneConstantsFm.FormActivate(Sender: TObject);
begin
