...
uses
  ...
  uGlobals, Grids, Printers, VclTee.TeeGDIPlus;
...
{   Buttons
{------------------------------------------------------------------------------}
procedure TfrmStats.StartBtnClick(Sender: TObject);
begin
  Series1.Clear;
...
procedure TfrmStats.PrintBtnClick(Sender: TObject);
var
  PrintRect : TRect;
  loop,YVal : integer;
  XVal      : integer;
...
procedure TfrmStats.CloseBtnClick(Sender: TObject);
begin
  frmStats.Close;
end;
{------------------------------------------------------------------------------}
{   Calculate
{------------------------------------------------------------------------------}
procedure TfrmStats.CalcValues;
const
  NumBin = 100;
  MaxValue = 50000;
var
...
function TfrmStats.Z(Row : integer) : extended;
